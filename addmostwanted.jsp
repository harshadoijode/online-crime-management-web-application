...
<p align="center" class="style1">Add To most wanted List </p>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="456" border="0" align="center">
	...
	<tr>
      <td width="172"><span class="style2">Age</span></td>
    ...
    <tr>
      <td><span class="style2">Crime list </span></td>
...
int x=stmt.executeUpdate("insert into wanted values('"+request.getParameter("of1")+"','"+request.getParameter("of2")+"','"+request.getParameter("of3")+"','"+request.getParameter("of4")+"','"+"images/"+request.getParameter("of5")+"')");


if(x!=0){
%>
<script> alert("wanted person added successfully");</script>
<%
}else{
%>
<script> alert("fail to add wanted person");</script>
<%
}
}
