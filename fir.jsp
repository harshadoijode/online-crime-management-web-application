...
int x=stmt.executeUpdate("insert into fir(name,crime,`complaint given by`,`crime place`,photo,`status`) values('"+request.getParameter("of1")+"','"+request.getParameter("of2")+"','"+request.getParameter("of3")+"','"+request.getParameter("of4")+"','"+"images/"+request.getParameter("of5")+"','"+request.getParameter("of6")+"')");


if(x!=0){
%>
<script> alert("FIR added successfully");</script>
<%
}else{
%>
