...
<p align="center" class="style1">Add New Officer </p>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="auto" border="0" align="center">
    <tr>
      <td ><span class="style2">Officer name </span></td>
      <td ><input name="of1" type="text" id="of1" />      </td>
    </tr>
	<tr>
      <td ><span class="style2">Officer Password </span></td>
      <td ><input name="of2" type="text" id="of2" />      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td><span class="style2">Contact Number </span></td>
      <td><input name="of5" type="text" id="of5" /></td>
    </tr>
    <tr>
...
int x=stmt.executeUpdate("insert into officer(officername,password,designation,location,contactno) values('"+request.getParameter("of1")+"','"+request.getParameter("of2")+"','"+request.getParameter("of3")+"','"+request.getParameter("of4")+"','"+request.getParameter("of5")+"')");
